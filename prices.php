...
<div class="prices">
    ...
    <div class="banner-icon">
        <div class="banner-icon-inner light-grey-bg">
            <h2 class="text-center heading">Prices and subscription plans</h2>
            <p class="text-center p-text">Everything from a completely simple and digital rental contract, to guaranteed rent due every single month</p>
            <div class="container-lg px-md-3 px-0">
                <div class="row mx-0">
                    <div class="col-md-4 my-md-0 my-2 px-md-3 px-0">
